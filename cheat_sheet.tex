...
% % from http://tex.stackexchange.com/questions/10682/suppress-in-biblatex
\renewbibmacro{in:}{%
...
% espace vertical dans la bibliographie
\setlength{\biblabelsep}{0.1\labelsep}
